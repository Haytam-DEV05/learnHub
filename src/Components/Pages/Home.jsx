  ...
  return (
    <div className="min-h-screen flex justify-center items-center">
      <div className="container text-center mx-1">
        <p className="py-1 px-8 text-red-800 bg-red-300 rounded-[50px] max-w-fit mx-auto">
          New courses added weekly
        </p>
        <h1 className="font-bold text-[60px] md:max-w-[70%] md:mx-auto">
          Learn Anything, <span className="text-red-300 ">Anywhere</span>
        </h1>
        <p className="text-[16px] font-light my-5">
