  ...
  return (
    <div className="course bg-(--card-bg) rounded-4xl shadow-md">
      ...
      <div className="content p-5 space-x-3.5">
        ...
        <h2 className="text-[16px] font-bold my-2 line-clamp-1">{course.title}</h2>
      ...
      <div className="bottom-card p-3 border-t border-gray-300 mx-4 flex justify-between items-center my-2">
        <span className="text-(--primary) text-[20px] font-bold">${course.price}</span>
        <button className="bg-(--accent) px-5 py-2 cursor-pointer rounded-md ">Enroll Now</button>
      </div>
    </div>
  );
}
